...
func (m *MongoEvent) Create(b []byte) (error, result mongo.InsertOneResult) {
...
// Get by Id
func (m *MongoEvent) GetById(b []byte) (error, Fsm) {
	collection := m.ClientDB.Database("nameService").Collection("namePackage")
...
// Get list
func (m *MongoEvent) GetList(b []byte) (error, Fsm) {
	collection := m.ClientDB.Database("nameService").Collection("namePackage")
...
// Delete
func (m *MongoEvent) Destroy(b []byte) (error, result mongo.DeleteResult) {
	collection := m.ClientDB.Database("nameService").Collection("namePackage")
